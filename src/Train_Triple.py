...
tf.app.flags.DEFINE_float('beta', 0.001, 'KL divergence weight (beta-VAE)')
tf.app.flags.DEFINE_float('recon_weight', 1.0, 'Reconstruction loss weight (L1)')
...
class Training_config(object):
    ...
    def __init__(self):
        ...
        self.recon_weight = FLAGS.recon_weight
